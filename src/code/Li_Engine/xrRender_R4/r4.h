...
#include "../xrRenderCommon/r__dsgraph_structure.h"
#include "../xrRenderCommon/r__occlusion.h"

#include "../xrRenderCommon/PSLibrary.h"

#include "r2_types.h"
#include "r4_rendertarget.h"
#include "../xrRenderCommon/hom.h"
#include "../xrRenderCommon/detailmanager.h"
#include "../xrRenderCommon/modelpool.h"
#include "../xrRenderCommon/wallmarksengine.h"
#include "smap_allocator.h"
#include "../xrRenderCommon/light_db.h"
#include "light_render_direct.h"
#include "../xrRenderCommon/LightTrack.h"
#include "../xrRenderCommon/r_sun_cascades.h"
...
public:
    ...
    virtual void add_Visual(IRenderVisual* V); // add visual leaf	(no culling performed at
                                               // all)
    virtual void add_Geometry(IRenderVisual* V); // add visual(s)	(all culling performed)

    // wallmarks
    virtual void add_StaticWallmark(ref_shader& S, const Fvector& P, float s, CDB::TRI* T,
                                    Fvector* V);
    virtual void add_StaticWallmark(IWallMarkArray* pArray, const Fvector& P, float s, CDB::TRI* T,
                                    Fvector* V);
    virtual void add_StaticWallmark(const wm_shader& S, const Fvector& P, float s, CDB::TRI* T,
                                    Fvector* V);
    virtual void clear_static_wallmarks();
    virtual void add_SkeletonWallmark(intrusive_ptr<CSkeletonWallmark> wm);
    virtual void add_SkeletonWallmark(const Fmatrix* xf, CKinematics* obj, ref_shader& sh,
