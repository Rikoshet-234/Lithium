...
void CBlender_deffer_model::Compile(CBlender_Compile& C) {
    ...
    if (bForward) {
        ...
        case 1: //
            ...
            C.r_Pass(vsname, psname, TRUE, TRUE, FALSE, TRUE, D3DBLEND_SRCALPHA,
        ...
        bool bUseATOC =
            (bAref && (RImplementation.o.dx10_msaa_alphatest == CRender::MSAA_ATEST_DX10_0_ATOC));
        ...
        case SE_R2_SHADOW: // smap
            if (bAref) {
                ...
                // FALSE,TRUE,TRUE,FALSE,D3DBLEND_ZERO,D3DBLEND_ONE,TRUE,220);  else
                // C.r_Pass	("shadow_direct_model_aref","shadow_direct_base_aref",	FALSE);
                // C.r_Sampler		("s_base",C.L_textures[0]);
                C.r_Pass("shadow_direct_model_aref", "shadow_direct_base_aref", FALSE, TRUE, TRUE,
