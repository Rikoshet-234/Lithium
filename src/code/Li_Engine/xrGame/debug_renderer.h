...
private:
    void add_lines(Fvector const* vertices, u32 const& vertex_count, u16 const* pairs,
...
public:
    IC void draw_line(const Fmatrix& matrix, const Fvector& vertex0, const Fvector& vertex1,
                      const u32& color);
