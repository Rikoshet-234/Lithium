...
void ISpatialScript::script_register	(lua_State *L)
{
        ...
        [
                class_<ISpatial,CISpatialWrapper>("ISpatial")
                        .def(constructor<>())
                        .def("spatial_register",	&ISpatial::spatial_register,
&CISpatialWrapper::spatial_register_static) .def("spatial_unregister",
&ISpatial::spatial_unregister,	&CISpatialWrapper::spatial_unregister_static) .def("spatial_move",
&ISpatial::spatial_move,		&CISpatialWrapper::spatial_move_static)
...
&ISpatial::dcast_FeelSound,		&CISpatialWrapper::dcast_FeelSound_static)
                        .def("dcast_Renderable",	&ISpatial::dcast_Renderable,
&CISpatialWrapper::dcast_Renderable_static)
                        .def("dcast_Light",			&ISpatial::dcast_Light,
&CISpatialWrapper::dcast_Light_static)
        ];
}
*/
...
void ISheduledScript::script_register(lua_State* L) {
    module(
        L)[class_<ISheduled, CISheduledWrapper>("ISheduled")
           ...
           //&ISheduled::shedule_Update,		&CISheduledWrapper::shedule_Update_static)
    ];
}
...
void CObjectScript::script_register(lua_State* L) {
    module(L)[
        ...
        /*
                                .def("spatial_register",	&CObject::spatial_register,
           &CObjectWrapper::spatial_register_static) .def("spatial_unregister",
           &CObject::spatial_unregister,	&CObjectWrapper::spatial_unregister_static)
                                .def("spatial_move",		&CObject::spatial_move,
           &CObjectWrapper::spatial_move_static)
                                ...
                                .def("dcast_FeelSound",		&CObject::dcast_FeelSound,
           &CObjectWrapper::dcast_FeelSound_static) .def("dcast_Light",
           &CObject::dcast_Light,			&CObjectWrapper::dcast_Light_static)
        */
        //			.def("shedule_Scale",		&CObject::shedule_Scale,
        //&CObjectWrapper::shedule_Scale_static) 			.def("shedule_Update",
        //&CObject::shedule_Update,		&CObjectWrapper::shedule_Update_static)
        ...
        class_<CGameObject, bases<DLL_Pure, ISheduled, ICollidable, IRenderable>,
            ...
            /*
               ...
               &CGameObjectWrapper::spatial_unregister_static) .def("spatial_move",
