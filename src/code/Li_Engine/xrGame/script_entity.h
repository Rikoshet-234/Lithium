...
public:
    struct CSavedSound {
        ...
        IC CSavedSound(u16 game_object_id, int sound_type, const Fvector& position,
                       float sound_power)
...
public:
    const Fmatrix GetUpdatedMatrix(shared_str caBoneName, const Fvector& tPositionOffset,
    ...
    virtual void sound_callback(const CObject* object, int sound_type, const Fvector& position,
                                float sound_power);
