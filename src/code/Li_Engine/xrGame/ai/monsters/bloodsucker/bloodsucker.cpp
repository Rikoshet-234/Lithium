...
void CAI_Bloodsucker::Load(LPCSTR section) {
    ...
    if (pSettings->line_exist(section, "is_no_fx")) {
        ...
        anim().AddAnim(eAnimStandIdle, "stand_idle_", -1, &velocity_none, PS_STAND, "fx_run_f",
        ...
        anim().AddAnim(eAnimStandTurnRight, "stand_turn_rs_", -1, &velocity_turn, PS_STAND,
                       "fx_run_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");
        anim().AddAnim(eAnimSleep, "lie_sleep_", -1, &velocity_none, PS_LIE, "fx_run_f",
                       "fx_stand_b", "fx_stand_l", "fx_stand_r");
        anim().AddAnim(eAnimSleepStanding, "stand_sleep_", -1, &velocity_none, PS_STAND, "fx_run_f",
                       "fx_stand_b", "fx_stand_l", "fx_stand_r");
        anim().AddAnim(eAnimWalkFwd, "stand_walk_fwd_", -1, &velocity_walk, PS_STAND, "fx_run_f",
                       "fx_stand_b", "fx_stand_l", "fx_stand_r");
        anim().AddAnim(eAnimWalkDamaged, "stand_walk_fwd_dmg_", -1, &velocity_walk_dmg, PS_STAND,
                       "fx_run_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");
        anim().AddAnim(eAnimRun, "stand_run_", -1, &velocity_run, PS_STAND, "fx_run_f",
                       "fx_stand_b", "fx_stand_l", "fx_stand_r");
        anim().AddAnim(eAnimRunDamaged, "stand_run_dmg_", -1, &velocity_run_dmg, PS_STAND,
                       "fx_run_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");
        ...
        anim().AddAnim(eAnimRunTurnRight, "stand_run_turn_right_", -1, &velocity_run, PS_STAND,
                       "fx_run_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");
        anim().AddAnim(eAnimScared, "stand_scared_", -1, &velocity_none, PS_STAND, "fx_run_f",
                       "fx_stand_b", "fx_stand_l", "fx_stand_r");

        anim().AddAnim(eAnimCheckCorpse, "stand_check_corpse_", -1, &velocity_none, PS_STAND,
                       "fx_run_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");
        anim().AddAnim(eAnimEat, "sit_eat_", -1, &velocity_none, PS_SIT, "fx_run_f", "fx_stand_b",
                       "fx_stand_l", "fx_stand_r");

        anim().AddAnim(eAnimDie, "stand_idle_", -1, &velocity_none, PS_STAND, "fx_run_f",
                       "fx_stand_b", "fx_stand_l", "fx_stand_r");

        anim().AddAnim(eAnimAttack, "stand_attack_", -1, &velocity_turn, PS_STAND, "fx_run_f",
                       "fx_stand_b", "fx_stand_l", "fx_stand_r");
        anim().AddAnim(eAnimAttackRun, "stand_attack_run_", -1, &velocity_run, PS_STAND, "fx_run_f",
                       "fx_stand_b", "fx_stand_l", "fx_stand_r");

        anim().AddAnim(eAnimLookAround, "stand_look_around_", -1, &velocity_none, PS_STAND,
                       "fx_run_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");
        anim().AddAnim(eAnimSitIdle, "sit_idle_", -1, &velocity_none, PS_SIT, "fx_run_f",
                       "fx_stand_b", "fx_stand_l", "fx_stand_r");
        anim().AddAnim(eAnimSitStandUp, "sit_stand_up_", -1, &velocity_none, PS_SIT, "fx_run_f",
                       "fx_stand_b", "fx_stand_l", "fx_stand_r");
        anim().AddAnim(eAnimSitToSleep, "sit_sleep_down_", -1, &velocity_none, PS_SIT, "fx_run_f",
                       "fx_stand_b", "fx_stand_l", "fx_stand_r");
        anim().AddAnim(eAnimStandSitDown, "stand_sit_down_", -1, &velocity_none, PS_STAND,
                       "fx_run_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");

        anim().AddAnim(eAnimSteal, "stand_steal_", -1, &velocity_steal, PS_STAND, "fx_run_f",
                       "fx_stand_b", "fx_stand_l", "fx_stand_r");

        anim().AddAnim(eAnimThreaten, "stand_threaten_", -1, &velocity_none, PS_STAND, "fx_run_f",
                       "fx_stand_b", "fx_stand_l", "fx_stand_r");
        anim().AddAnim(eAnimMiscAction_00, "stand_to_aggressive_", -1, &velocity_none, PS_STAND,
                       "fx_run_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");
    }
    ...
    // define transitions
    //	anim().AddTransition(PS_STAND,			eAnimThreaten,	eAnimMiscAction_00,
    //false);
    ...
    m_visibility_state_change_min_delay =
        READ_IF_EXISTS(pSettings, r_u32, section, "visibility_state_change_min_delay",
                       default_visibility_state_change_min_delay);

    m_full_visibility_radius = READ_IF_EXISTS(
        pSettings, r_float, section, full_visibility_radius_string, default_full_visibility_radius);
    m_partial_visibility_radius =
        READ_IF_EXISTS(pSettings, r_float, section, partial_visibility_radius_string,
...
void CAI_Bloodsucker::reinit() {
    ...
    com_man().ta_fill_data(anim_triple_vampire, "vampire_0", "vampire_1", "vampire_2",
    ...
    // PI - 0.01f, SControlRotationJumpData::eStopAtOnce | SControlRotationJumpData::eRotateOnce);
    com_man().add_rotation_jump_data("run_turn_l_0", "run_turn_l_1", "run_turn_r_0", "run_turn_r_1",
                                     PI_DIV_2);

    com_man().load_jump_data("boloto_jump_prepare", 0, "boloto_jump_fly", "boloto_jump_end",
                             u32(-1), MonsterMovement::eBloodsuckerVelocityParameterJumpGround, 0);
...
void CAI_Bloodsucker::reload(LPCSTR section) {
    ...
    sound().add(pSettings->r_string(section, "Sound_Vampire_Grasp"), DEFAULT_SAMPLE_COUNT,
                SOUND_TYPE_MONSTER_ATTACKING, MonsterSound::eHighPriority + 4,
    ...
    sound().add(pSettings->r_string(section, "Sound_Vampire_Hit"), DEFAULT_SAMPLE_COUNT,
    ...
    sound().add(pSettings->r_string(section, "Sound_Vampire_StartHunt"), DEFAULT_SAMPLE_COUNT,
                SOUND_TYPE_MONSTER_ATTACKING, MonsterSound::eHighPriority + 5,
                MonsterSound::eBaseChannel, eVampireStartHunt, "bip01_head");
    sound().add(pSettings->r_string(section, "Sound_Invisibility_Change_State"),
                DEFAULT_SAMPLE_COUNT, SOUND_TYPE_MONSTER_ATTACKING, MonsterSound::eNormalPriority,
                MonsterSound::eChannelIndependent << 1, eChangeVisibility, "bip01_head");
    sound().add(pSettings->r_string(section, "Sound_Growl"), DEFAULT_SAMPLE_COUNT,
                SOUND_TYPE_MONSTER_ATTACKING, MonsterSound::eHighPriority + 6,
                MonsterSound::eBaseChannel, eGrowl, "bip01_head");
    sound().add(pSettings->r_string(section, "Sound_Alien"), DEFAULT_SAMPLE_COUNT,
...
void CAI_Bloodsucker::LoadVampirePPEffector(LPCSTR section) {
    ...
    sscanf(pSettings->r_string(section, "color_base"), "%f,%f,%f",
           &pp_vampire_effector.color_base.r, &pp_vampire_effector.color_base.g,
           &pp_vampire_effector.color_base.b);
    sscanf(pSettings->r_string(section, "color_gray"), "%f,%f,%f",
           &pp_vampire_effector.color_gray.r, &pp_vampire_effector.color_gray.g,
...
void CAI_Bloodsucker::vfAssignBones() {
    ...
    if (!PPhysicsShell()) //нельзя ставить колбеки, если создан физ шел - у него стоят свои
                          //колбеки!!!
    {
...
void CAI_Bloodsucker::LookDirection(Fvector to_dir, float bone_turn_speed) {
    ...
    // float cur_yaw = -movement().m_body.current.yaw;						// текущий мировой угол
    // монстра
    // float bone_angle;											// угол для
    // боны

    // float dy = _abs(angle_normalize_signed(yaw - cur_yaw));		// дельта, на которую нужно
    // поворачиваться

    // if (angle_difference(cur_yaw,yaw) <= MAX_BONE_ANGLE) {		// bone turn only
    //	bone_angle = dy;
    //} else {													// torso & bone
    //turn 	if (movement().IsMoveAlongPathFinished() || !movement().enabled())
    //movement().m_body.target.yaw = angle_normalize(-yaw); 	if (dy / 2 < MAX_BONE_ANGLE)
    //bone_angle = dy / 2; 	else bone_angle = MAX_BONE_ANGLE;
    //}
...
void CAI_Bloodsucker::set_visibility_state(visibility_t new_state) {
    ...
    if (Device.dwTimeGlobal <
        m_visibility_state_last_changed_time + get_visibility_state_change_min_delay()) {
        return;
    }
...
void CAI_Bloodsucker::update_invisibility() {
    ...
    if (!g_Alive()) {
        set_visibility_state(full_visibility);
               ...
               m_runaway_invisible_time + default_runaway_invisible_time / 6) {
...
void CAI_Bloodsucker::set_drag_jump(CEntityAlive* e, LPCSTR s, const Fvector& position,
                                    float factor) {
    j_position = position;
    j_factor = factor;
    m_cob = e;
...
void CAI_Bloodsucker::start_drag() {
    if (m_animated) {
        ...
        smart_cast<IKinematicsAnimated*>(Visual())->PlayCycle("boloto_attack_link_bone", TRUE,
                                                              animation_end_jump, this);
        m_animated = false;
    }
}
...
void CAI_Bloodsucker::predator_start() {
    ...
    CParticlesPlayer::StartParticles(invisible_particle_name, Fvector().set(0.0f, 0.1f, 0.0f),
                                     ID());
    sound().play(CAI_Bloodsucker::eChangeVisibility);
...
CBaseMonster::SDebugInfo CAI_Bloodsucker::show_debug_info() {
    ...
    string128 text;
    xr_sprintf(text, "Vampire Want Value = [%f] Speed = [%f]", m_vampire_want_value,
               m_vampire_want_speed);
    DBG().text(this).add_item(text, info.x, info.y += info.delta_y, info.color);
    DBG().text(this).add_item("---------------------------------------", info.x,
                              info.y += info.delta_y, info.delimiter_color);
