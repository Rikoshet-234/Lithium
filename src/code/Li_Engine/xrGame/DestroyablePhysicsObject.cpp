...
BOOL CDestroyablePhysicsObject::net_Spawn(CSE_Abstract* DC) {
    ...
    // R_ASSERT2(ini->section_exist("destroyed"),"destroyable_object must have -destroyed- section
    // in model user data");
    CPHDestroyable::Init();
...
// void CDestroyablePhysicsObject::Hit							(float P,Fvector
// &dir,CObject *who,s16 element,Fvector p_in_object_space, float impulse,  ALife::EHitType hit_type)
