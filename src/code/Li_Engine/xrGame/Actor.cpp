...
BOOL g_b_OldStylePickupMode = FALSE;
...
CActor::CActor() : CEntityAlive(), current_ik_cam_shift(0) {
	...
	// Scht.
	m_pda_disabled = pSettings->r_bool_def("Li_GameplaySettings", "pda_enabled", FALSE);
	// -- Scht.
}
...
void CActor::UpdateCL() {
    if (g_Alive() && Level().CurrentViewEntity() == this && g_b_OldStylePickupMode == FALSE) 
	{
