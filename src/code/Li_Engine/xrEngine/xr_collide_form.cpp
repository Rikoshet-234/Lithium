...
void CCF_Skeleton::SElement::center(Fvector& center) const {
    ...
    case SBoneShape::stBox:
        center.set(-b_IM.c.dotproduct(b_IM.i), -b_IM.c.dotproduct(b_IM.j),
...
IC bool RAYvsOBB(const Fmatrix& IM, const Fvector& b_hsize, const Fvector& S, const Fvector& D,
                 float& R, BOOL bCull) {
...
IC bool RAYvsSPHERE(const Fsphere& s_sphere, const Fvector& S, const Fvector& D, float& R,
                    BOOL bCull) {
...
IC bool RAYvsCYLINDER(const Fcylinder& c_cylinder, const Fvector& S, const Fvector& D, float& R,
                      BOOL bCull) {
    // Actual test
