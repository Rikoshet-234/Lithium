...
void r_pixel_calculator::begin() {
    ...
    R_CHK(HW.pDevice->CreateDepthStencilSurface(rt_dimensions, rt_dimensions, HW.Caps.fDepth,
...
r_aabb_ssa r_pixel_calculator::calculate(dxRender_Visual* V) {
    ...
    for (u32 face = 0; face < 6; face++) {
        ...
        D3DXMatrixOrthoOffCenterLH((D3DXMATRIX*)&mProject, aabb.min.x, aabb.max.x, aabb.min.y,
                                   aabb.max.y, aabb.min.z, aabb.max.z);
