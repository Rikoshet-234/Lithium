...
#ifdef DEBUG
    F.OutNext("SH/T/M/C:    %d/%d/%d/%d", RCache.stat.states, RCache.stat.textures,
              RCache.stat.matrices, RCache.stat.constants);
...
void dxStatsRender::OutData4(CGameFont& F) {
    ...
    F.OutNext("dynamic:       %3.1f/%d", RCache.stat.r.s_dynamic.verts / 1024.f,
    ...
    F.OutNext("  dynamic_3B:  %3.1f/%d", RCache.stat.r.s_dynamic_3B.verts / 1024.f,
              RCache.stat.r.s_dynamic_3B.dips);
    F.OutNext("  dynamic_4B:  %3.1f/%d", RCache.stat.r.s_dynamic_4B.verts / 1024.f,
              RCache.stat.r.s_dynamic_4B.dips);
    F.OutNext("details:       %3.1f/%d", RCache.stat.r.s_details.verts / 1024.f,
