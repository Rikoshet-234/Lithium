...
xr_token ttype_token[] = {
    { "2D Texture", STextureParams::ttImage }, { "Cube Map", STextureParams::ttCubeMap },
...
//         break;
//     case ttNormalMap:
//         flags.set(flImplicitLighted | flBinaryAlpha | flAlphaBorder | flColorBorder |
//                       flFadeToColor | flFadeToAlpha | flDitherColor | flDitherEachMIPLevel |
//                       flBumpDetail,
//                   FALSE);
...
//         break;
//     case ttTerrain:
//         flags.set(flGenerateMipMaps | flBinaryAlpha | flAlphaBorder | flColorBorder |
//                       flFadeToColor | flFadeToAlpha | flDitherColor | flDitherEachMIPLevel |
//                       flBumpDetail,
//                   FALSE);
...
void STextureParams::FillProp(LPCSTR base_name, PropItemVec& items,
...
// 
//         //		PHelper().CreateFlag32		(items, "Flags\\Binary Alpha",
//         //&flags,				flBinaryAlpha);
...
//         break;
//     case ttBumpMap:
//         PHelper().CreateChoose(items, "Bump\\Special NormalMap", &ext_normal_map_name, smTexture,
//                                base_name);
//         PHelper().CreateFloat(items, "Bump\\Virtual Height (m)", &bump_virtual_height, 0.f, 0.1f,
//                               0.001f, 3);
//         break;
//     case ttNormalMap:
