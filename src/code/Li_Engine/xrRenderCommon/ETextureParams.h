...
struct ECORE_API STextureParams {
    enum ETType { ttImage = 0, ttCubeMap, ttBumpMap, ttNormalMap, ttTerrain, ttForceU32 = u32(-1) };
    enum ETFormat {
        tfDXT1 = 0,
        tfADXT1,
        tfDXT3,
    ...
    enum ETBumpMode { tbmResereved = 0, tbmNone, tbmUse, tbmUseParallax, tbmForceU32 = u32(-1) };
    enum ETMaterial {
        tmOrenNayar_Blin = 0,
        tmBlin_Phong,
        tmPhong_Metal,
