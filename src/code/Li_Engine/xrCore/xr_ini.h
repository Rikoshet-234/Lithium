...
public:
	...
	BOOL r_bool_def(LPCSTR S, LPCSTR L, BOOL def_val = FALSE) const;
	BOOL r_bool_def(const shared_str& S, LPCSTR L, BOOL def_val = FALSE) const { return r_bool_def(*S, L, def_val); }
