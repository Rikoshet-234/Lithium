...
#if !defined(_EDITOR) || defined(Li_EDITOR)
...
IC char* strconcat(int dest_sz, char* dest, const char* S1, const char* S2, const char* S3,
                   const char* S4) {
    return xr_strcat(xr_strcat(xr_strcat(xr_strcpy(dest, dest_sz, S1), dest_sz, S2), dest_sz, S3),
                     dest_sz, S4);
}
...
IC char* strconcat(int dest_sz, char* dest, const char* S1, const char* S2, const char* S3,
                   const char* S4, const char* S5) {
    return xr_strcat(
        xr_strcat(xr_strcat(xr_strcat(xr_strcpy(dest, dest_sz, S1), dest_sz, S2), dest_sz, S3),
                  dest_sz, S4),
        dest_sz, S5);
}
