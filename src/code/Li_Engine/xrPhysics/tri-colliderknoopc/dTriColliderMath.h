...
inline bool TriContainPoint(const dReal* v0, const dReal* v1, const dReal* v2,
                            ...
                            const dReal* triSideAx2, const dReal* triAx, const dReal* pos) {
...
inline bool TriPlaneContainPoint(const dReal* v0, const dReal* v1, const dReal* v2,
                                 const dReal* pos) {
...
inline void PlanePoint(const Triangle& tri, const dReal* from, const dReal* to, float from_dist,
                       dReal* point) {
...
ICF void InitTriangle(CDB::TRI* XTri, Triangle& triangle, const Fvector* V_array) {
    const Point vertices[3] = { Point((dReal*)&V_array[XTri->verts[0]]),
