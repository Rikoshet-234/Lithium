...
void CBlender_Compile::r_Stencil(BOOL Enable, u32 Func, u32 Mask, u32 WriteMask, u32 Fail, u32 Pass,
                                 u32 ZFail) {
...
u32 CBlender_Compile::r_dx10Sampler(LPCSTR ResourceName) {
    ...
    //	Use	D3DTADDRESS_WRAP,	D3DTEXF_LINEAR,			D3DTEXF_LINEAR,
    //D3DTEXF_LINEAR
...
void CBlender_Compile::r_Pass(LPCSTR _vs, LPCSTR _gs, LPCSTR _ps, bool bFog, BOOL bZtest,
...
#ifdef USE_DX11
void CBlender_Compile::r_TessPass(LPCSTR vs, LPCSTR hs, LPCSTR ds, LPCSTR gs, LPCSTR ps, bool bFog,
                                  BOOL bZtest, BOOL bZwrite, BOOL bABlend, D3DBLEND abSRC,
